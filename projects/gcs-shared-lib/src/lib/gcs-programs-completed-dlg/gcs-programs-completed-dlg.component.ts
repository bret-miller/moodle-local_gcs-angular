...
@Component({
  selector: 'lib-gcs-programs-completed-dlg',
  templateUrl: './gcs-programs-completed-dlg.component.html',
  styleUrl: './gcs-programs-completed-dlg.component.css'
})
export class GcsProgramsCompletedDlgComponent {
