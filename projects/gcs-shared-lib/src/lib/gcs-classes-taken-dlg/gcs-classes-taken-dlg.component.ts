...
@Component({
  selector: 'lib-gcs-classes-taken-dlg',
  templateUrl: './gcs-classes-taken-dlg.component.html',
  styleUrl: './gcs-classes-taken-dlg.component.css'
})
export class GcsClassesTakenDlgComponent {
