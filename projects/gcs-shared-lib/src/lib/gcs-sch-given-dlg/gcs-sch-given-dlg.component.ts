...
@Component({
  selector: 'lib-gcs-sch-given-dlg',
  templateUrl: './gcs-sch-given-dlg.component.html',
  styleUrl: './gcs-sch-given-dlg.component.css'
})
export class GcsSchGivenDlgComponent {
